...
#define ERRMSG(msg, ...) Info::add(InfoItem(Info::Severity::Error,__FILE__, __LINE__, msg, ##__VA_ARGS__))
#define WARNING(msg, ...) Info::add(InfoItem(Info::Severity::Warning,__FILE__, __LINE__, msg, ##__VA_ARGS__))
#define PROGRESS(msg, ...) Info::add(InfoItem(Info::Severity::Progress, "", 0, msg, ##__VA_ARGS__))
#define INFO(msg, ...) Info::add(InfoItem(Info::Severity::Info, QString(), 0, msg, ##__VA_ARGS__))
#define TRACE(msg, ...) Info::add(InfoItem(Info::Severity::Debug,__FILE__, __LINE__, msg, ##__VA_ARGS__))
#define DETAIL(msg, ...) Info::add(InfoItem(Info::Severity::Detail,QString(), 0, msg, ##__VA_ARGS__))
#define ENTER(msg, ...) Info::add(InfoItem(Info::Severity::Enter,__FILE__, __LINE__, "Entering " msg, ##__VA_ARGS__))
#define LEAVE(msg, ...) Info::add(InfoItem(Info::Severity::Leave,__FILE__, __LINE__, "\\Leaving " msg, ##__VA_ARGS__))
#define DUMPVAR(var) Info::add(InfoItem(Info::Severity::Debug, QString(), 0, "%1 = %2", #var, var))
