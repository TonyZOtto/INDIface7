...
{
    mRandom = QRandomGenerator::securelySeeded();
    baseDir = QDir::root();
    dataDir = QDir::root();
    ...
    Return::add(FaceBase::ReturnNewBaseDir, "INDI FaceBase: New base directory at %1", ddtInfo);
    ...
    Return::add(FaceBase::ReturnInitialized, "INDI FaceBase Initialized: %1 People, %2 Faces, %3 Non-searchable", ddtInfo);
    Return::add(FaceBase::ReturnStatus, "People: %1 identified, %2 unidenfied; Faces: %3 Total, %4 Searchable", ddtInfo);
} // c'tor
